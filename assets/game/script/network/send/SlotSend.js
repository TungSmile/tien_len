...
var SlotSend = {
    spin(typeChoi, idHu, tienCuoc, level, line, lixi = 0) {
        var arraySend = {
        }
        var sendData = {
        };
        ...
        var tempString = 1005 + SocketConstant.SEPERATOR.N4 + typeChoi + SocketConstant.SEPERATOR.ELEMENT + idHu + SocketConstant.SEPERATOR.ELEMENT
            + tienCuoc + SocketConstant.SEPERATOR.ELEMENT + level + SocketConstant.SEPERATOR.ELEMENT + line + SocketConstant.SEPERATOR.ELEMENT + lixi;
