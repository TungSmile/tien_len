...
var LobbySend = {
    ...
    requestGhepDoi(uid = 0, zoneId = 0 , minMoney = 0, isCancel = false) {
        var arraySend = {
        }
        var sendData = {
        }
        arraySend.r = [];
        var tempString = 12021 + SocketConstant.SEPERATOR.N4 + uid + SocketConstant.SEPERATOR.ELEMENT +
        zoneId + SocketConstant.SEPERATOR.ELEMENT + minMoney + SocketConstant.SEPERATOR.ELEMENT + isCancel;
        sendData.v = tempString;
        arraySend.r.push(sendData);
        return JSON.stringify(arraySend);
    },
