    ...
    parse_1108_message(messageId, status, data) {
        ...
        if (status == 1) {
            ...
            if (Linker.ZONE == BiDaConstant.ZONE_ID.ZONEID_1VS4) {
                ...
                if (Utils.Malicious.isJsonString(tempArray1[2])) {
                    message.dataBall = tempArray1[2];
                }
                if (tempArray1.length > 2) {
                    message.isBotInTable = Number(tempArray1[3]) != 0 ? true : false;
                } else {
                ...
                if (tempArray1.length >= 3) {
                    ...
                    var _myCardTarget = tempArray1[4];
    ...
    GameEndResponse(messageId, status, data) {
        ...
        if (status == 1) {
            ...
            for (var i = 0; i < roomParam.length; i++) {
                ...
                player.level = playerResult[7];
                player.levelUpMoney = playerResult[8];
                message.playerList.push(player);
            }
            message.listPlayer = message.playerList;
    ...
    GameEndResponseBidaPhom(messageId, status, data) {
        ...
        if (status == 1) {
            ...
            for (var i = 0; i < roomParam.length; i++) {
                ...
                player.level = playerResult[9];
                player.levelUpMoney = playerResult[10];
            }
        }
        else {
            message.error = data;
