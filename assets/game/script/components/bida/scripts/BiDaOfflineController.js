...
cc.Class({
    ...
    addCustomEvent: function () {
        ...
        this.node.on(Constant.GAME_COMMONS_EVENT.OFFLINE_TIME_OUT, this.onTimeOut, this);
        this.node.on(Constant.POPUP_EVENT.FRIEND_ZONE.OPEN, this.onBtnClick, this);
        this.node.on(Constant.POPUP_EVENT.FRIEND_ZONE.CLOSE, this.onBtnClick, this);
    },
    onDestroy() {
                ...
                switch (this.gameState) {
                    case BiDaConstant.GAME_STATE.WAIT: {
                        if (Number(message.cancelStatus) == 0) {
                            var customEvent = new cc.Event.EventCustom(Constant.GAME_LOBBY_EVENT.REQUEST_LOBBY_FOR_ZONE_ID_TYPE, true);
    ...
    onBtnClick(event) {
        switch (event.type) {
            ...
            case Constant.POPUP_EVENT.FRIEND_ZONE.OPEN: {
                if (this.FriendsZone) {
            ...
            case Constant.POPUP_EVENT.FRIEND_ZONE.CLOSE: {
                if (this.FriendsZone) {
