...
var BiDaSend = {
    ...
    //FootBall
    turnKickBallRequest(zoneId, tableId, data) {
        var arraySend = {
        }
        var sendData = {
        }
        ...
        var tempString = 1104 +
            SocketConstant.SEPERATOR.N4 + zoneId +
            SocketConstant.SEPERATOR.ELEMENT + tableId +
            SocketConstant.SEPERATOR.ELEMENT + data.cueStatus +
            SocketConstant.SEPERATOR.ELEMENT + data.id +
            SocketConstant.SEPERATOR.ELEMENT + JSON.stringify(data.position) +
            SocketConstant.SEPERATOR.ELEMENT + data.hitGoal;
        sendData.v = tempString;
        arraySend.r.push(sendData);
        return JSON.stringify(arraySend);
    },
