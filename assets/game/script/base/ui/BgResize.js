cc.Class({
    ...
    onResize: function () {
        if (cc.Canvas.instance.node.getComponent("CanvasAdaptive")) {
            this.node.width = cc.Canvas.instance.node.width;
            this.node.height = cc.Canvas.instance.node.height;
            return;
        }
        this.bgSprite = this.getBgSpriteGame();
        if (this.bgSprite && cc.isValid(this.bgSprite && this.bgSprite.spriteFrame)) {
            ...
            if (_texture) {
                ...
                var centerComponent = this.node.getComponent("CenterScreenPosition");
                if (centerComponent) {
                    centerComponent.repositionCenter();
                }
            }
        }
